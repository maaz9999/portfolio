...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, rgba(249,115,22,0.18) 0%, rgba(124,58,237,0.18) 100%)';
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  behindGlowColor = 'rgba(249, 115, 22, 0.67)',
  behindGlowSize = '45%',
  className = '',
  enableTilt = true,
  ...
  const cardStyle = useMemo(
    () =>
      ({
        ...
        '--behind-glow-color': behindGlowColor ?? 'rgba(249, 115, 22, 0.67)',
